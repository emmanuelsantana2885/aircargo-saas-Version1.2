...
class FeignContractSyncTest {
    ...
    @Test
    void userDto_contractIsSubsetOfAppUserDto() {
        assertContract(com.aircargo.feign.dto.UserDTO.class, AppUserDTO.class, "UserDTO");
    }

    @Test
    void siteDto_contractIsSubsetOfServiceDto() {
        assertContract(com.aircargo.feign.dto.SiteDTO.class, SiteDTO.class, "SiteDTO");
    }
}
