...
public class DuaRecordController {
    ...
    @PostMapping
    public ResponseEntity<DuaRecordDTO> create(@RequestBody DuaRecordDTO dto,
    ...
    @PutMapping("/{id}")
    public ResponseEntity<DuaRecordDTO> update(@PathVariable UUID id, @RequestBody DuaRecordDTO dto,
                                                @AuthenticationPrincipal UserPrincipal principal,
                                                HttpServletRequest request) {
