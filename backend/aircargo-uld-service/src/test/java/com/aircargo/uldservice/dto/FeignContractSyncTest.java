...
class FeignContractSyncTest {
    ...
    @Test
    void uldDto_contractIsSubsetOfServiceDto() {
        assertContract(com.aircargo.feign.dto.UldDTO.class, UldDTO.class, "UldDTO");
    }

    @Test
    void uldAwbDto_contractIsSubsetOfServiceDto() {
        assertContract(com.aircargo.feign.dto.UldAwbDTO.class, UldAwbDTO.class, "UldAwbDTO");
    }
}
